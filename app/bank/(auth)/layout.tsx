        ...
        <div className="flex">
            ...
            <div className="w-96 flex flex-col gap-8 border-l h-screen overflow-y-auto scrollbar-y">
                ...
                <div className="flex flex-col relative gap-16">
                    <div className="h-32 bg-gradient-to-r from-black via-gray-500 to-white"></div>

                    <Image src={``} alt="user-pic" className="w-28 h-28 rounded-full bg-black border-4 border-white absolute top-16 self-center shadow" />
