...
export default function Layout({ children }: Readonly<{ children: React.ReactNode }>) {
    ...
    return (
        <div className="flex">
            ...
            <div className="w-64 flex flex-col gap-8 border-r h-screen overflow-y-auto scrollbar-y justify-between">
                ...
                <div className="flex flex-col gap-10 px-5 py-10">
                    ...
                    <div className="flex flex-col gap-5">
                        <Link href={`/bank`} className={`flex items-center gap-4 ${pathname == '/bank' ? 'text-black' : 'hover:text-black text-gray-500'}`}>
                        ...
                        <Link href={`/bank/myBanks`} className={`flex items-center gap-4 ${pathname == '/bank/myBanks' ? 'text-black' : 'hover:text-black text-gray-500'}`}>
                ...
                <div className="flex justify-between items-center border-t py-5 px-3">
                    <div className="flex gap-2">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-r from-black to-white"></div>
                    ...
                    <button className="text-gray-500">
                        <svg className="size-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M7.87828 12.07C7.87828 11.66 8.21828 11.32 8.62828 11.32H14.1083V2.86C14.0983 2.38 13.7183 2 13.2383 2C7.34828 2 3.23828 6.11 3.23828 12C3.23828 17.89 7.34828 22 13.2383 22C13.7083 22 14.0983 21.62 14.0983 21.14V12.81H8.62828C8.20828 12.82 7.87828 12.48 7.87828 12.07Z" fill="currentColor"></path> <path d="M20.5416 11.5402L17.7016 8.69016C17.4116 8.40016 16.9316 8.40016 16.6416 8.69016C16.3516 8.98016 16.3516 9.46016 16.6416 9.75016L18.2016 11.3102H14.1016V12.8102H18.1916L16.6316 14.3702C16.3416 14.6602 16.3416 15.1402 16.6316 15.4302C16.7816 15.5802 16.9716 15.6502 17.1616 15.6502C17.3516 15.6502 17.5416 15.5802 17.6916 15.4302L20.5316 12.5802C20.8316 12.3002 20.8316 11.8302 20.5416 11.5402Z" fill="currentColor"></path> </g></svg>
                    </button>
                </div>
            ...
            <div className="w-96 flex flex-col gap-8 border-l h-screen overflow-y-auto scrollbar-y">
